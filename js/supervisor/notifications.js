// ===== TrainUp - Supervisor Notifications JavaScript =====
...
function loadUserInfo(userData) {
    ...
    if (userNameEl) userNameEl.textContent = profile ? `${profile.firstName || ''} ${profile.lastName || ''}`.trim() : 'Supervisor';
    if (userEmailEl) userEmailEl.textContent = userData.email;
    if (userAvatarEl) userAvatarEl.textContent = profile ? getInitials(profile.firstName, profile.lastName) : 'S';
}
    ...
    return [
        {
            ...
            message: 'A new company "TechCorp" has registered and is pending verification.',
            isRead: false,
            createdAt: new Date().toISOString(),
            actionUrl: 'companies.html',
            metadata: {
                companyId: 'comp1',
        ...
        },
        {
            id: '2',
            type: 'APPLICATION_UPDATE',
            title: 'New Internship Pending Review',
            message: 'A new internship "Software Developer Intern" has been posted and requires your review.',
            isRead: false,
        ...
        },
        {
            ...
            title: 'Completion Approval Request',
            message: 'A student has requested approval for internship completion.',
            isRead: true,
