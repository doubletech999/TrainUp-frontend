...
/**
 * Refresh supervisor dashboard manually
 */
async function refreshSupervisorDashboard() {
    const button = document.getElementById('supervisorRefreshBtn');
    ...
    try {
        ...
        console.error('Error refreshing supervisor dashboard:', error);
