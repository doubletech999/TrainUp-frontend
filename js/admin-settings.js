...
function populateSettings(settings) {
    ...
    if (settings.general) {
        ...
        document.getElementById('maintenanceMode').value = settings.general.maintenanceMode || 'false';
        document.getElementById('registrationEnabled').value = settings.general.registrationEnabled || 'true';
    }
...
async function testEmail() {
    ...
    try {
        const response = await apiRequest('/admin/settings/test-email', { method: 'POST' });
        if (response.success) {
