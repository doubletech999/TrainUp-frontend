...
function populateForm(internship) {
    ...
    document.getElementById('category').value = internship.category || '';
    document.getElementById('location').value = internship.location || '';
    document.getElementById('type').value = internship.type || 'ON_SITE';
    document.getElementById('duration').value = internship.duration || '';
    document.getElementById('numberOfPositions').value = internship.numberOfPositions || 1;
    ...
    if (internship.applicationDeadline) {
        document.getElementById('applicationDeadline').value = internship.applicationDeadline.split('T')[0];
    }

    // Stipend
    document.getElementById('isPaid').value = internship.isPaid ? 'true' : 'false';
    if (internship.isPaid && internship.stipend) {
        document.getElementById('stipend').value = internship.stipend;
        document.getElementById('stipendGroup').style.display = 'block';
    }
