...
async function approveInternship(internshipId, notes = '') {
    try {
        ...
        const response = await apiRequest(API_ENDPOINTS.ADMIN.APPROVE_INTERNSHIP(internshipId), {
            method: 'PUT',
...
async function rejectInternship(internshipId, notes) {
    try {
        ...
        const response = await apiRequest(API_ENDPOINTS.ADMIN.REJECT_INTERNSHIP(internshipId), {
            method: 'PUT',
...
window.approveInternshipFromModal = approveInternshipFromModal;
window.rejectInternshipFromModal = rejectInternshipFromModal;
window.viewDetails = viewDetails;
window.quickApprove = quickApprove;
window.quickReject = quickReject;
window.archiveInternship = archiveInternship;
